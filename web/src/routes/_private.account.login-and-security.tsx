...
import { SetPasswordForm, SetPasswordFormSchema } from "src/account/SetPasswordForm";
import { UpdatePasswordForm, UpdatePasswordFormSchema } from "src/account/UpdatePasswordForm";
...
export const action = Remix.unwrapAction(
  Effect.gen(function* () {
    ...
    return Effect.gen(function* () {
      ...
      const SetPassword = (form: SetPasswordFormSchema) =>
      ...
      return yield* ServerRequest.formData(Forms).pipe(
        ...
        Effect.catchTags({
          CredentialAlreadyInUse: () => ServerResponse.Fail("Those credentials are already in use"),
          CredentialNotRecognised: () => ServerResponse.Fail("Your current password is incorrect"),
