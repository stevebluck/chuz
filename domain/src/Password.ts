...
export const Plaintext = S.NonEmptyString.pipe(S.brand("PlaintextPassword"));

export const Strong = S.String.pipe(
  S.minLength(8),
  S.maxLength(64),
  S.brand("StrongPassword"),
  S.annotations({ message: () => "Your password needs to be a bit stronger!" }),
);

export const Hashed = S.NonEmptyString.pipe(S.brand("HashedPassword"));
